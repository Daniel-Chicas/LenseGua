        ...
        while video.isOpened():
            ...
            if there_hand(results):
                ...
                if count_frame > margin_frame:
                    cv2.putText(image, 'Capturando...', FONT_POS,
                                FONT, FONT_SIZE, (255, 50, 0))
                ...
                if len(frames) > min_cant_frames + margin_frame:
                    ...
                    output_folder = os.path.join(
                        path, f"sample_{cant_sample_exist + count_sample + 1}")
                ...
                cv2.putText(image, 'Listo para capturar...',
                            FONT_POS, FONT, FONT_SIZE, (0, 220, 100))

            draw_keypoints(image, results)
            cv2.imshow(
                f'Toma de muestras para "{os.path.basename(path)}"', image)
